namespace NYH.CoreCardSystem
{
    ...
    public class ActionSystem : Singleton<ActionSystem>
    {
        ...
        private IEnumerator PerformRections()
        {
        ...
        {
            Type type = typeof(T);
            Func<GameAction, IEnumerator> wrapperedPerformer = action => performer((T)action);
        ...
        public static void SubscribeReaction<T>(Action<T> reaction, ReactionTiming timing) where T : GameAction
        {
            ...
            void wrapperedReaction(GameAction action) => reaction((T)action);
